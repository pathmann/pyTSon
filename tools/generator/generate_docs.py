...
EXTRA_FILES = [("..", "..", "ressources", "pytsonui.py"), ("..", "..", "ressources", "pytson.py"), ("..", "..", "ressources", "devtools.py"), ("..", "..", "ressources", "ts3client.py"), ("..", "..", "ressources", "pluginhost.py"), ("..", "..", "ressources", "ts3widgets.py")]
